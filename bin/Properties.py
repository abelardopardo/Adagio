...
"""
A Python replacement for java.util.Properties class This is modelled as closely
as possible to the Java original.

Created - Anand B Pillai <abpillai@gmail.com>
Modified - Abelardo Pardo <abelardo.pardo@uc3m.es>
"""
...
if __name__=="__main__":
    ...
    p.list()
    print 'Object: ' + str(p)
    print 'Items: ' + str(p.items())
    print p.has_key('testing')
